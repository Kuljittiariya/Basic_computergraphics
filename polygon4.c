    ...
    for(i=0;i<sides*2;i=i+2)
    {
        ...
        switch(orientation)
        {
            case OUT2IN:
                    ...
                    tempPoly[j+1] = cy;
                    j = j+2;
                    printf("left clip1: %d,%d\n",cx,cy);

                    tempPoly[j]   = x2;
                    tempPoly[j+1] = y2;
                    j = j+2;
                    printf("left clip2: %d,%d\n",x2,y2);
                    incrside++;
                    break;
            case IN:
                    tempPoly[j]   = x2;
    ...
    for(i=0;i<sides*2;i=i+2)
    {
        ...
        switch(orientation)
        {
            case OUT2IN:
                    ...
                    tempPoly[j+1] = cy;
                    j = j+2;
                    printf("bottom clip1: %d,%d\n",cx,cy);

                    tempPoly[j]   = x2;
                    tempPoly[j+1] = y2;
                    j = j+2;
                    printf("bottom clip2: %d,%d\n",x2,y2);
                    incrside++;
                    break;
            case IN:
                    tempPoly[j]   = x2;
    ...
    for(i=0;i<sides*2;i=i+2)
    {
        ...
        switch(orientation)
        {
            case OUT2IN:
                    ...
                    tempPoly[j+1] = cy;
                    j = j+2;
                    printf("right clip1: %d,%d\n",cx,cy);


                    tempPoly[j]   = x2;
                    tempPoly[j+1] = y2;
                    j = j+2;
                    printf("right clip2: %d,%d\n",x2,y2);
                    incrside++;
                    break;
            case IN:
                    tempPoly[j]   = x2;
    ...
    for(i=0;i<sides*2;i=i+2)
    {
        ...
        switch(orientation)
        {
            case OUT2IN:
                    ...
                    tempPoly[j+1] = cy;
                    j = j+2;
                    printf("top clip1: %d,%d\n",cx,cy);

                    tempPoly[j]   = x2;
                    tempPoly[j+1] = y2;
                    j = j+2;
                    printf("top clip2: %d,%d\n",x2,y2);
...
int main()
{
    ...
    printf("Enter the window in term of (x min,y min): ");
    scanf("%d,%d",&xmin,&ymin);
    printf("Enter the window in term of (x max,y max): ");
    scanf("%d,%d",&xmax,&ymax);
